...
CREATE TABLE `device` (
  ...
  `DeviceActions` int DEFAULT NULL,
...
INSERT INTO `device` VALUES (1,'Friday','Kernel sexta-feira',10),(2,'Interface','Interface sexta-feira',10);
...
INSERT INTO `homeworkmanagement` VALUES (1,'Type','subject','homework','2030-06-02','desc'),(6,'t','t','t','2020-07-12','t');
...
INSERT INTO `projects` VALUES (2,'tese','teste'),(3,'tes','test');
...
-- Dump completed on 2020-07-23 20:31:04
